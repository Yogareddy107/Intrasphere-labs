...
const SportRetailProject = () => {
  return (
    ...
    >
      <SEO 
        title="Intrasphere Labs - Performance Athletic Footwear Project" 
      ...
      <div className="bg-gray-50 p-6 rounded-lg mb-8">
        ...
        <p>
          A global sports retail leader approached Intrasphere Labs with a vision to revolutionize the development, 
      ...
      <p>
  Intrasphere Labs developed a comprehensive smart footwear R&D platform that includes:
      </p>
      ...
      <div className="bg-blue-50 p-6 rounded-lg mt-8 flex items-start">
        ...
        <div>
          ...
          <p>
            Intrasphere Labs continues to partner with this client on this R&D initiative to refine the prototype and 
