...
const SEO: React.FC<SEOProps> = ({
  title = 'Intrasphere Labs',
  description = 'Intrasphere Labs: Premier software and web development agency specializing in scalable, secure, and innovative digital solutions for the modern era.',
  type = 'website',
  name = 'Intrasphere Labs',
  imageUrl = '/lovable-uploads/48ecf6e2-5a98-4a9d-af6f-ae2265cd4098.png',
  publishDate,
  modifiedDate,
  author,
  category,
  keywords = ['software development', 'web development', 'custom web applications', 'mobile app development', 'full-stack development', 'React development', 'cloud solutions', 'AI applications'],
  isBlogPost = false
}) => {
  const location = useLocation();
  const currentUrl = `https://intrasphere.netlify.app${location.pathname}`;
  const absoluteImageUrl = imageUrl.startsWith('http') ? imageUrl : `https://intrasphere.netlify.app${imageUrl}`;
  ...
  const organizationStructuredData = {
    ...
    '@type': 'Organization',
    name: 'Intrasphere Labs',
    url: 'https://intrasphere.netlify.app',
    logo: 'https://intrasphere.netlify.app/lovable-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png',
    description: 'Premier software and web development agency specializing in scalable, secure, and innovative digital solutions.',
    contactPoint: {
      '@type': 'ContactPoint',
  ...
  name: 'Intrasphere Labs',
      logo: {
        '@type': 'ImageObject',
        url: 'https://intrasphere.netlify.app/lovable-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png',
        width: 512,
        height: 512
      },
      url: 'https://intrasphere.netlify.app'
  ...
  <meta property="og:site_name" content="Intrasphere Labs" />
      <meta property="og:locale" content="en_US" />
      {isBlogPost && category && <meta property="article:section" content={category} />}
      {isBlogPost && publishDate && <meta property="article:published_time" content={publishDate} />}
      {isBlogPost && modifiedDate && <meta property="article:modified_time" content={modifiedDate} />}
      {isBlogPost && <meta property="article:publisher" content="https://intrasphere.netlify.app" />}
      ...
      <meta name="twitter:site" content="@IntrasphereLabs" />
      <meta name="twitter:creator" content="@IntrasphereLabs" />
