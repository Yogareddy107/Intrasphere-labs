  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        to_name: 'Intrasphere Labs Team', // Adding recipient name parameter
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-700 text-black">
              ...
              <a href="mailto:teamintrasphere@gmail.com" className="text-blue-500 hover:underline">teamintrasphere@gmail.com</a>
